...
const char* UDP_HOST  = SERVER_HOST; // IMU 数据发送到同一台后端服务器
...
void setup() {
  ...
  wsCam.onMessage([](WebsocketsMessage msg){
    if (msg.isText()){
      ...
      else if (cmd.startsWith("SET:QUALITY=")) {     // 动态调整画质
